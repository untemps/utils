...
describe('resolveClassName', () => {
    ...
    { input: [[true, null]], expected: '' },
    { input: [[true]], expected: '' },
    { input: [[true, 'foo']], expected: 'foo' },
    { input: [[true, 'foo', 'bar']], expected: 'foo' },
    { input: [[false, 'foo']], expected: '' },
    { input: [[false, 'foo', 'bar']], expected: 'bar' },
    {
      input: [
        [false, 'foo', 'bar'],
        [true, 'foo', 'bar']
    ...
    expect(resolveClassName(input as unknown as Parameters<typeof resolveClassName>[0])).toBe(expected)
  })
})
