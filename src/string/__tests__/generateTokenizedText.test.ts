import { generateTokenizedText, GenerateTokenizedTextConfig } from '../generateTokenizedText'
...
describe('generateTokenizedText', () => {
	...
	it.each([
		...
		expect(() => generateTokenizedText(values as unknown as GenerateTokenizedTextConfig)).toThrow()
	})
})
